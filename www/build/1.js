...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__firma_foto__ = __webpack_require__(306);
...
var FirmaFotoPageModule = /** @class */ (function () {
    function FirmaFotoPageModule() {
    }
    FirmaFotoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__firma_foto__["a" /* FirmaFotoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3_angular2_signaturepad__["SignaturePadModule"],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__firma_foto__["a" /* FirmaFotoPage */]),
            ],
        })
    ], FirmaFotoPageModule);
    return FirmaFotoPageModule;
}());

//# sourceMappingURL=firma-foto.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FirmaFotoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_signaturepad_signature_pad__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sweetalert__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_sweetalert2__ = __webpack_require__(294);
...
var FirmaFotoPage = /** @class */ (function () {
    function FirmaFotoPage(navCtrl, navParams, view, http, camara, loadingController) {
        ...
        this.image = [];
        this.cal = localStorage.getItem('cal_area');
    }
    FirmaFotoPage.prototype.ionViewDidLoad = function () {
    };
    FirmaFotoPage.prototype.closeModal = function () {
        this.view.dismiss();
    };
    FirmaFotoPage.prototype.canvasResize = function () {
        var canvas = document.querySelector('canvas');
        this.signaturePad.set('minWidth', 1);
        this.signaturePad.set('canvasWidth', canvas.offsetWidth);
        this.signaturePad.set('canvasHeight', canvas.offsetHeight);
    };
    FirmaFotoPage.prototype.ngAfterViewInit = function () {
        console.log("Reset Model Screen");
        this.signaturePad.clear();
        this.canvasResize();
    };
    FirmaFotoPage.prototype.drawComplete = function () {
        console.log(this.signaturePad.toDataURL());
        this.report.signature = this.signaturePad.toDataURL();
    };
    FirmaFotoPage.prototype.drawStart = function () {
        console.log('begin drawing');
    };
    FirmaFotoPage.prototype.foto = function () {
        var _this = this;
        var options = {
        ...
        this.camara.getPicture(options).then(function (imageData) {
            _this.image.push("data:image/jpeg;base64," + imageData);
            _this.report.photos.push("data:image/jpeg;base64," + imageData);
        }, function (err) {
            __WEBPACK_IMPORTED_MODULE_5_sweetalert___default()("No se pudo guardar la imágen", "", "error");
        });
    };
    FirmaFotoPage.prototype.enviar = function () {
        var _this = this;
        ...
        this.http.post(this.url, this.report)
            ...
            console.log(res);
            _this.score = res;
            if (_this.score.reportStore.score.toFixed(2) <= 5) {
            ...
            if (_this.score.reportStore.score.toFixed(2) > 5 && _this.score.reportStore.score.toFixed(2) <= 7) {
                __WEBPACK_IMPORTED_MODULE_6_sweetalert2___default.a.fire({
            ...
            if (_this.score.reportStore.score.toFixed(2) > 7 && _this.score.reportStore.score.toFixed(2) < 9) {
                __WEBPACK_IMPORTED_MODULE_6_sweetalert2___default.a.fire({
            ...
            if (_this.score.reportStore.score.toFixed(2) > 9 && _this.score.reportStore.score.toFixed(2) <= 10) {
                __WEBPACK_IMPORTED_MODULE_6_sweetalert2___default.a.fire({
...
//# sourceMappingURL=firma-foto.js.map
