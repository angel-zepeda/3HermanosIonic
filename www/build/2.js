    ...
    AspectsPage.prototype.validateForm = function (aspects) {
        ...
        if (aspects.name == "Ventas") {
            ...
            __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default.a.fire({
                html: '<h1 style="color:white; font-size:4.55rem;">Exito! </h1>' +
            ...
            if (count > 0) {
                __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default.a.fire({
                    html: '<h1 style="color:white; font-size:5rem;">Oops! </h1>' +
                ...
                if (this.aspects.name == "Bodega") {
                    ...
                    localStorage.setItem("report", JSON.stringify(report));
                    __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default.a.fire({
                        html: '<h1 style="color:white; font-size:4.5rem;">Exito! </h1>' +
                            '<h2 style="color: white">El reporte se ha llenado correctamente. </h2>',
                        icon: "success",
                        background: "rgba(0,0,0,0.7)",
                        backdrop: "url('https://image.freepik.com/free-photo/leather-shoes-wooden-background_1203-7617.jpg')",
