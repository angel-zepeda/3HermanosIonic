...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__aspects__ = __webpack_require__(315);
...
var AspectsPageModule = /** @class */ (function () {
    function AspectsPageModule() {
    }
    AspectsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__aspects__["a" /* AspectsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__aspects__["a" /* AspectsPage */]),
            ],
        })
    ], AspectsPageModule);
    return AspectsPageModule;
}());

//# sourceMappingURL=aspects.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AspectsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_sweetalert2__ = __webpack_require__(294);
...
var AspectsPage = /** @class */ (function () {
    function AspectsPage(navCtrl, view) {
    ...
    AspectsPage.prototype.openModal = function (name) {
        __WEBPACK_IMPORTED_MODULE_2_sweetalert2___default.a.fire({ imageUrl: '' + name });
    };
    AspectsPage.prototype.enviar = function () {
        this.validateForm(this.aspects);
    };
    AspectsPage.prototype.validateForm = function (aspects) {
        var count = 0;
        var report;
        if (aspects.name == 'Ventas') {
            for (var _i = 0, _a = aspects.aspects; _i < _a.length; _i++) {
                var a = _a[_i];
                if (a.score === '') {
                    a.score = "10";
                }
            ...
            for (var _b = 0, _c = aspects.aspects; _b < _c.length; _b++) {
                var a = _c[_b];
                if (a.score === '') {
                    count++;
                }
    ...
    AspectsPage.prototype.calProdV = function () {
        ...
        var dias = 7;
        var pares = parseInt(this.valProd.pares);
        var vendedores = parseInt(this.valProd.vendedores);
        var res = 0;
        res = pares / dias / vendedores;
        resHtml.innerHTML = "Resultado: " + Math.floor(res);
    };
    AspectsPage.prototype.calProdTienda = function () {
        var resHtml = document.getElementById('resProdTienda');
        var dias = 7;
        var pares = parseInt(this.valTiendaProd.pares);
        var mt2 = parseInt(this.valTiendaProd.mt2);
        var res = 0;
        res = pares / dias / mt2;
